...
<nav class="bg-white shadow-md p-4 fixed w-full z-10">
    <div class="container mx-auto flex justify-between items-center">
        <div class="flex items-center space-x-4">
            ...
            <button x-show="!isNavOpen" @click="isNavOpen = true" class="md:hidden focus:outline-none">
        ...
        <!-- Navigation links -->
        <div :class="{'hidden': !isNavOpen, 'flex': isNavOpen}" class="md:flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-6 absolute md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0">
            <button @click="switchTab('dashboard'); isNavOpen = false" class="flex items-center px-3 py-2 rounded hover:bg-gray-100">
            ...
            <button @click="switchTab('face-recognition'); isNavOpen = false" class="flex items-center px-3 py-2 rounded hover:bg-gray-100">
            ...
            <button @click="switchTab('schedule-session'); isNavOpen = false" class="flex items-center px-3 py-2 rounded hover:bg-gray-100">
            ...
            <button @click="switchTab('attendance-history'); isNavOpen = false" class="flex items-center px-3 py-2 rounded hover:bg-gray-100">
            ...
            <button @click="switchTab('my-units'); isNavOpen = false" class="flex items-center px-3 py-2 rounded hover:bg-gray-100">
            ...
            <button @click="switchTab('profile'); isNavOpen = false" class="flex items-center px-3 py-2 rounded hover:bg-gray-100">
            ...
            <button @click="switchTab('notifications'); isNavOpen = false" class="relative flex items-center px-3 py-2 rounded hover:bg-gray-100">
                ...
                Notifications
                <span x-text="notificationCount" class="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full px-2" x-show="notificationCount > 0"></span>
            </button>
        </div>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('navbar', () => ({
        ...
        async updateNotifications() {
            ...
            this.notificationCount = res.data.filter(n => !n.is_read).length;
        },
        init() {
