...
<nav class="bg-gray-900 shadow-lg p-4 fixed w-full z-10">
    <div class="container mx-auto flex justify-between items-center">
        <div class="flex items-center space-x-4">
            <span class="text-xl font-bold text-yellow-400">SUNATT</span>
        ...
        <!-- Navigation links -->
        <div id="nav-menu" class="hidden md:flex flex-col md:flex-row md:items-center space-y-2 md:space-y-0 md:space-x-6 absolute md:static top-16 left-0 w-full md:w-auto bg-gray-800 md:bg-transparent shadow-md md:shadow-none p-4 md:p-0">
            <button onclick="switchTab('dashboard'); toggleNav()" class="flex items-center px-3 py-2 rounded hover:bg-gray-700 text-white">
            ...
            <button onclick="switchTab('face-recognition'); toggleNav()" class="flex items-center px-3 py-2 rounded hover:bg-gray-700 text-white">
            ...
            <button onclick="switchTab('schedule-session'); toggleNav()" class="flex items-center px-3 py-2 rounded hover:bg-gray-700 text-white">
            ...
            <button onclick="switchTab('attendance-history'); toggleNav()" class="flex items-center px-3 py-2 rounded hover:bg-gray-700 text-white">
            ...
            <button onclick="switchTab('my-units'); toggleNav()" class="flex items-center px-3 py-2 rounded hover:bg-gray-700 text-white">
            ...
            <button onclick="switchTab('profile'); toggleNav()" class="flex items-center px-3 py-2 rounded hover:bg-gray-700 text-white">
            ...
            <button onclick="switchTab('notifications'); toggleNav()" class="relative flex items-center px-3 py-2 rounded hover:bg-gray-700 text-white">
        ...
        <div class="flex items-center space-x-4">
            <span class="text-gray-300">Hello, <?= htmlspecialchars($_SESSION['username']) ?></span>
