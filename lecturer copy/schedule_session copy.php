...
<body class="bg-gray-900 text-white min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-6 flex-grow">
        <h1 class="text-3xl font-bold text-theme mb-6" role="heading" aria-level="1">Schedule Attendance Session</h1>
        ...
        <section class="bg-gray-800 rounded-lg shadow-lg max-w-lg mx-auto p-6 mb-8">
            <form id="schedule-form" method="POST" action="schedule_session.php" aria-label="Schedule Attendance Session">
                ...
                <button type="submit"
                        class="w-full bg-theme text-white font-semibold py-2 rounded hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-theme relative"
    ...
    <script>
        ...
        function openEditModal(session, unitName) {
            ...
            // Set min date for session date
            const today = new Date().toISOString().split('T')[0];
            document.getElementById('edit_session_date').setAttribute('min', today);
